...
*/	
	...
	SELECT MONTH(ORDEN.FVENTA) AS MES, YEAR(ORDEN.FVENTA) AS AÑO, CUSTOMER.NOMBRE AS NOMBRE, CUSTOMER.APELLIDO AS APELLIDO, TOP_USUARIOS.TOTAL_VENTAS AS TOTAL_VENTAS, TOP_USUARIOS.TOTAL_PRECIO AS TOTAL_PRECIO
	FROM CUSTOMER
	JOIN ORDEN
	  ON CUSTOMER.ID_CUSTOMER = ORDEN.ID_CUSTOMER
	JOIN (
